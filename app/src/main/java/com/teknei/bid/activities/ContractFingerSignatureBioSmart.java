...
public class ContractFingerSignatureBioSmart extends BaseActivity implements FingersPresenter.View, LicensePresenter.Ui,
        BioCaptureResultListener, BioCaptureFeedbackListener, View.OnClickListener {

    private static final String TAG = "ContractFingerSignatureBioSmart";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contract_finger_signature_bio_smart);
        ...
        btnCaptureFinger = (ImageView) findViewById(R.id.cfs_bio_b_take_image_bio_sdk);
        btnContinue      = (Button)    findViewById(R.id.cfs_bio_b_continue);

        btnCaptureFinger.setOnClickListener(ContractFingerSignatureBioSmart.this);
        btnContinue.setOnClickListener     (ContractFingerSignatureBioSmart.this);
        ...
        licensePresenter.setUi(ContractFingerSignatureBioSmart.this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.cfs_bio_b_continue:
                if (validateIndexFingers()) {
                    sendPetition();
                }
                break;
            case R.id.cfs_bio_b_take_image_bio_sdk:
                try {
    ...
    public boolean validateIndexFingers() {
        ...
        if (base64FingerLogin.length()>0) {
            ...
            bitMapTake = false;
            Toast.makeText(ContractFingerSignatureBioSmart.this, "Capture huella del dedo índice", Toast.LENGTH_SHORT).show();
        }
        return bitMapTake;
    }
    ...
    public void showImages(List<byte[]> jpgImages) {
        ...
        String operationID  =
                SharedPreferencesUtils.readFromPreferencesString
                        (ContractFingerSignatureBioSmart.this, SharedPreferencesUtils.OPERATION_ID, "");
    ...
    public void sendPetition() {
        ...
        fingerDTO    = new FingerSingDTO(base64FingerLogin,Long.parseLong(idOperation));

        new SendFingerSignContract(ContractFingerSignatureBioSmart.this, token, fingerDTO).execute();
    }

    public void confirmContract() {
        String token = SharedPreferencesUtils.readFromPreferencesString(this, SharedPreferencesUtils.TOKEN_APP, "");
        new ConfirmSignContract(ContractFingerSignatureBioSmart.this, token, fingerDTO).execute();
    }
    ...
    public void goNext() {
        ...
        Intent i = new Intent(ContractFingerSignatureBioSmart.this, ResultOperationActivity.class);
        startActivity(i);
    }
}
