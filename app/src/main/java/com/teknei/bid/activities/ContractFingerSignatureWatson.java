...
public class ContractFingerSignatureWatson extends BaseActivity implements View.OnClickListener, WatsonMiniListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contract_finger_signature_watson);
        ...
        imageViewPreview    = (ImageView) findViewById(R.id.cfs_wat_image_view_preview);
        buttonContinue      = (Button)    findViewById(R.id.cfs_wat_b_continue);
        buttonCaptureFinger = (Button)    findViewById(R.id.cfs_wat_b_capture_fingerprint);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.cfs_wat_b_capture_fingerprint:
    ...
    public boolean validateIndexFingers() {
        ...
        if ( imageFileFinger==null) {
            ...
            bitMapTake = false;
            Toast.makeText(ContractFingerSignatureWatson.this, "Debe capturar almenos una huella", Toast.LENGTH_SHORT).show();
    ...
    public void sendPetition() {
        ...
        new SendFingerSignContract(ContractFingerSignatureWatson.this, token, fingerDTO).execute();
    }

    public void confirmContract() {
        String token = SharedPreferencesUtils.readFromPreferencesString(this, SharedPreferencesUtils.TOKEN_APP, "");
        new ConfirmSignContract(ContractFingerSignatureWatson.this, token, fingerDTO).execute();
    }

    public String buildJSON() {
        fingerDTO = new FingerSingDTO();
        ...
        fingerDTO.setOperationId(Long.parseLong(idOperation));
        fingerDTO.setContentType("image/wsq");

        //Construimos el JSON
        JSONObject jsonObject = new JSONObject();
        try {
            jsonObject.put("operationId", Integer.parseInt(idOperation));
            jsonObject.put("emprId", idEnterprice);
            jsonObject.put("customerType", customerType);
            jsonObject.put("contentType", "image/wsq");
            jsonObject.put("base64Finger", base64FingerLogin);
    ...
    @Override
    public void goNext() {
        Intent i = new Intent(ContractFingerSignatureWatson.this, ResultOperationActivity.class);
        startActivity(i);
    }
    ...
    public void onCaptureFinishedSuccess(byte[] imageBuffer, final Bitmap imageBitmap, IBScanDevice.ImageFormat imageFormat) {
        ...
        String operationID = SharedPreferencesUtils.readFromPreferencesString(
                ContractFingerSignatureWatson.this, SharedPreferencesUtils.OPERATION_ID, "");
