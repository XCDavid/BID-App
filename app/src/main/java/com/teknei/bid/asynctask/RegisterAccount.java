...
public class RegisterAccount extends AsyncTask<String, Void, Void> {

    private final String CLASS_NAME = "RegisterAccount";
    ...
    public RegisterAccount(Activity activityOrigin, String token, AccountDTO accountDTO) {
        this.token = token;
