...
public class AlertCurpDialog extends Dialog implements View.OnClickListener {
    Button okButton;
    Button cancelButton;
    TextView txvTitle;
    TextView txvMessage;
    ...
    public AlertCurpDialog(Activity context, String title, String message, int action) {
        super(context);
        activityOrigin = context;
        /** 'Window.FEATURE_NO_TITLE' - Used to hide the title */
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        /** Design the dialog in main.xml file */
        setContentView(R.layout.alert_curp_dialog);

        this.titleIn = title;
        this.menssageIn = message;
        this.actionIn = action;

        txvTitle = (TextView) findViewById(R.id.alert_titleCurpDialog);
        txvMessage = (TextView) findViewById(R.id.alert_messageCurpDialog);
        okButton = (Button) findViewById(R.id.ok_buttomCurpDialog);
        cancelButton = (Button) findViewById(R.id.cancel_buttomCurpDialog);
...
//                }
                ...
                dialogoAlert.show();
                break;
            case R.id.cancel_buttomCurpDialog:
                dismiss();
                break;
        }
    }
