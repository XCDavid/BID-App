...
import com.teknei.bid1.asynctask.FingersSend;
import com.teknei.bid1.dialogs.AlertDialog;
import com.teknei.bid1.dialogs.FingerScanDialog;
import com.teknei.bid1.mso.MSOConnection;
import com.teknei.bid1.mso.MSOShower;
        ...
        if (imgFP != null) {
            ...
            switch (imgFP.getId()) {
                case R.id.b_pinky_left_arm:
                    finger = "I5";
                    fingerSelect = 10;
                    base64PinkyLeft = com.teknei.bid1.tools.Base64.encode(imgFPBuff);
                    break;
                case R.id.b_ring_left_arm:
                    finger = "I4";
                    fingerSelect = 9;
                    base64RingLeft = com.teknei.bid1.tools.Base64.encode(imgFPBuff);
                    break;
                case R.id.b_middle_left_arm:
                    finger = "I3";
                    fingerSelect = 8;
                    base64MiddleLeft = com.teknei.bid1.tools.Base64.encode(imgFPBuff);
                    break;
                case R.id.b_index_left_arm:
                    finger = "I2";
                    fingerSelect = 7;
                    base64IndexLeft = com.teknei.bid1.tools.Base64.encode(imgFPBuff);
                    break;
                case R.id.b_thumb_left_arm:
                    finger = "I1";
                    fingerSelect = 6;
                    base64ThumbLeft = com.teknei.bid1.tools.Base64.encode(imgFPBuff);
                    break;
                case R.id.b_pinky_right_arm:
                    finger = "D5";
                    fingerSelect = 5;
                    base64PinkyRight = com.teknei.bid1.tools.Base64.encode(imgFPBuff);
                    break;
                case R.id.b_ring_riht_arm:
                    finger = "D4";
                    fingerSelect = 4;
                    base64RingRight = com.teknei.bid1.tools.Base64.encode(imgFPBuff);
                    break;
                case R.id.b_middle_right_arm:
                    finger = "D3";
                    fingerSelect = 3;
                    base64MiddleRight = com.teknei.bid1.tools.Base64.encode(imgFPBuff);
                    break;
                case R.id.b_index_right_arm:
                    finger = "D2";
                    fingerSelect = 2;
                    base64IndexRight = com.teknei.bid1.tools.Base64.encode(imgFPBuff);
                    break;
                case R.id.b_thumb_right_arm:
                    finger = "D1";
                    fingerSelect = 1;
                    base64ThumbRight = com.teknei.bid1.tools.Base64.encode(imgFPBuff);
                    break;
            }
